...
const CountryMeal = ()=>{
    ...
    const [data,loading,errorMessage] = useFetch(`/filter.php?a=${country}`);
    ...
    return(
        ...
        <div className="text-center max-w-3xl padding-y ">
                <h1 className="text-5xl font-kanit bg-gradient-to-r from-blue-400 to-blue-800 bg-clip-text text-transparent">{country} Category</h1>
