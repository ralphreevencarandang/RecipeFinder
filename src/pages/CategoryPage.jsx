    ...
    return(
        <section className="max-container padding-x flex flex-col justify-center items-center">
            <div className="text-center max-w-3xl padding-y ">
                    <h1 className="text-5xl font-kanit bg-gradient-to-r from-blue-400 to-blue-800 bg-clip-text text-transparent">Browse Category</h1>
                ...
                (errorMessage ? 
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" >
                        ...
                        {data?.categories?.filter((d)=> d.strCategory.toLowerCase().includes(searchTerm.toLowerCase())).map((d, i)=> 
                            <Card key={i} imgUrl={d.strCategoryThumb} title={d.strCategory} id={d.idCategory} description={d.strCategoryDescription} category={d.strCategory} />
                        )}
